...
from backend.routers.public_api import router as public_api_router
from backend.routers import vark as vark_router
...
app.include_router(vark_router.router)
